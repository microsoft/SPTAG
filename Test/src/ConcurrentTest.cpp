...
template <typename T>
void ConcurrentAddSearchSave(SPTAG::IndexAlgoType algo, std::string distCalcMethod,
...
template <typename T> void CTest(SPTAG::IndexAlgoType algo, std::string distCalcMethod)
{
