...
namespace SPTAG
{
    ...
    namespace BKT
    {
        ...
        class Index : public VectorIndex
        {
            ...
            public:
                RebuildJob(COMMON::Dataset<T>* p_data, COMMON::BKTree* p_tree, COMMON::NeighborhoodGraph* p_graph, 
        ...
        private:
            ...
            // BKT structures. 
            std::shared_ptr<COMMON::BKTree> m_pTrees;
        ...
        public:
            Index()
            {
                ...
                m_pTrees.reset(new COMMON::BKTree());
