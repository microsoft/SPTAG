...
namespace SPTAG::SPANN {
    ...
    public:
                                  ...
                                  bool theSameHead)
        {
            ...
            newHeadsDist.push_back(m_headIndex->ComputeDistance(headVector, newHeadsVec[0]->data()));
            newHeadsDist.push_back(m_headIndex->ComputeDistance(headVector, newHeadsVec[1]->data()));
