...
DefineSSDParameter(m_postingQuantizerTargetRecallError, float, -1.0F, "PostingQuantizerTargetRecallError")
DefineSSDParameter(m_postingQuantizerRecallAt, int, 10, "PostingQuantizerRecallAt")
DefineSSDParameter(m_postingQuantizerTrainingQueryCount, int, 1000, "PostingQuantizerTrainingQueryCount")
DefineSSDParameter(m_postingQuantizerTrainingTruthDepth, int, 1000, "PostingQuantizerTrainingTruthDepth")
DefineSSDParameter(m_postingQuantizerTrainingDataFile, std::string, std::string(""), "PostingQuantizerTrainingDataFile")
DefineSSDParameter(m_postingQuantizerTrainingResultFile, std::string, std::string(""), "PostingQuantizerTrainingResultFile")
