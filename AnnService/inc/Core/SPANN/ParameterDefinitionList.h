...
DefineSSDParameter(m_hybridCostResultSafety, float, 2.0f, "HybridCostResultSafety")
DefineSSDParameter(m_hybridCostIOFixedUS, float, 8.0f, "HybridCostIOFixedUS")
DefineSSDParameter(m_hybridCostPageUS, float, 4.0f, "HybridCostPageUS")
DefineSSDParameter(m_hybridCostBytesPerUS, float, 4000.0f, "HybridCostBytesPerUS")
DefineSSDParameter(m_hybridCostVectorUS, float, 0.04f, "HybridCostVectorUS")
DefineSSDParameter(m_hybridCostMaxPostings, int, 2048, "HybridCostMaxPostings")
DefineSSDParameter(m_hybridCostHeadOriginalUS, float, 0.0f, "HybridCostHeadOriginalUS")
DefineSSDParameter(m_hybridCostHeadHybridUS, float, 0.0f, "HybridCostHeadHybridUS")
