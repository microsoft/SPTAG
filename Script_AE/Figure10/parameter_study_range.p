...
unset title
set yrange [0.93:1]
set ytics ("" 0.93, "0.94" 0.94, "" 0.95, "0.96" 0.96, "" 0.97, "0.98" 0.98, "" 0.99, "1" 1)
plot "parameter_study_range.csv" using 1:2 every ::3 with lines title 'Reassign top0' ls 1, \
     "parameter_study_range.csv" using 3:4 every ::3 with lines title 'Reassign top8' ls 2, \
     "parameter_study_range.csv" using 5:6 every ::3 with lines title 'Reassign top64' ls 3, \
     "parameter_study_range.csv" using 7:8 every ::3 with lines title 'Reassign top128' ls 4
unset key